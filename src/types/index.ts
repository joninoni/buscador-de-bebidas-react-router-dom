import { z } from "zod"
import { CategoriesApiResponseSchema, DrinkApiResponseSchema, DrinksApiResponseSchema, RecipeAPIResponseSchema, SearchFilterSchema } from "../schema/recipiesSchema"
...
//type para validar la informacion de cada receta
export type CurrencyDrink = z.infer<typeof RecipeAPIResponseSchema>